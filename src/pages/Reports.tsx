...
const Reports = () => {
  ...
  useEffect(() => {
    ...
    switch (assessmentType) {
      case 'diabetes':
        calculatedResult = assessmentData.diabetes ? 
          calculateDiabetesRisk(assessmentData.diabetes) : 
          { risk: 'unknown', score: 0, insights: [] };
        break;
      case 'heartDisease':
        calculatedResult = assessmentData.heartDisease ? 
          calculateHeartDiseaseRisk(assessmentData.heartDisease) : 
          { risk: 'unknown', score: 0, insights: [] };
        break;
      case 'parkinsons':
        calculatedResult = assessmentData.parkinsons ? 
          calculateParkinsonsRisk(assessmentData.parkinsons) : 
          { risk: 'unknown', score: 0, insights: [] };
        break;
      default:
        calculatedResult = {
  ...
  const getAssessmentTitle = () => {
    switch (assessmentType) {
      ...
      case 'heartDisease': return 'Heart Disease Risk Assessment';
      case 'parkinsons': return 'Parkinson\'s Disease Risk Assessment';
      default: return 'Health Assessment Report';
    }
  };
  ...
  const handlePrint = () => {
    ...
    setTimeout(() => {
      window.print();
      setTimeout(() => {
        document.documentElement.style.removeProperty('color-adjust');
    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-8 print:py-0 print:px-0">
        <div className="max-w-5xl mx-auto">
          ...
          <div 
            ref={printRef}
            className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border print:border-none print:shadow-none print:bg-white"
          >
            ...
            <div className="p-6 print:p-0">
              <div className="print:block mb-8 print:mb-6 print:break-inside-avoid">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg print:bg-gray-100 print:border print:border-gray-200">
                  <div className="mb-4">
                  ...
                  {result.insights.length > 0 ? (
                    result.insights.map((insight, index) => (
                      <div key={index} className="flex items-start">
                        <Info className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0 print:text-blue-700" />
                        <p className="dark:text-gray-200 print:text-black">{insight}</p>
                      </div>
                    ))
                  ) : (
                    <p className="dark:text-gray-200 print:text-black">No specific insights available for this assessment.</p>
                  )}
                </div>
              </div>
                ...
                <Card className="p-4 print:p-3 print:border print:border-gray-300 dark:border-gray-700 overflow-x-auto">
                  ...
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-700">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider print:text-black print:font-bold">Parameter</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider print:text-black print:font-bold">Value</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider print:text-black print:font-bold">Normal Range</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider print:text-black print:font-bold">Status</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {metricsTable.map((metric, index) => (
                        <tr key={index}>
                          <td className="px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-200 print:text-black">{metric.parameter}</td>
                          <td className="px-4 py-3 text-sm text-gray-900 dark:text-gray-200 print:text-black">{metric.value}</td>
                          <td className="px-4 py-3 text-sm text-gray-500 dark:text-gray-300 print:text-black">{metric.normalRange}</td>
              ...
              <div className="mb-8 print:mb-6 print:break-inside-avoid">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg print:bg-blue-50 print:border print:border-blue-100">
                  <ul className="list-disc pl-5 space-y-2 dark:text-gray-200 print:text-black">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 mt-8 border-t dark:border-gray-700 pt-4 print:text-xs print:mt-4 print:text-black">
